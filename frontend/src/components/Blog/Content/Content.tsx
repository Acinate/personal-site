  ...
  return (
    <div className="blog_content_container">
      <div className="blog_content_inner">
        <p>
          According to the <a href="#">React 16 Roadmap</a>, Concurrent Mode is
          just over the horizon. Expected to arrive in Q2 2019, here's what Dan
          Abramov has to say about Concurrent Mode:
        </p>
        <blockquote>
          ...
          example, text input or hover). Concurrent Mode also improves the user
          experience of Suspense by skipping unnecessary loading states on fast
          connections.
        </blockquote>
        <p>
          While Concurrent Mode is an opt-in feature, enabling it will be
          simple: just wrap part of your app with a{' '}
          <span className="inline-code">&lt;ConcurrentMode&gt; element:</span>
        </p>
...
<ConcurrentMode>
        ...
        <p>
          ...
          Concurrent Mode won’t work correctly. In fact, your entire app won’t
          work correctly. So to help you prepare, this short article compares
          some bad code with a good version, and then discusses what you can do
        ...
        <p>
          ...
          shouldn’t have any side effects, but it hadn’t really been an issue
          until Concurrent Mode appeared on the scene. In Concurrent Mode,
          render functions can be invoked multiple times without actually
          committing (meaning, for example, applying changes to the DOM).
        </p>
        <p>
